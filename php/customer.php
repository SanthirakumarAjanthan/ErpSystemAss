    ...
    <div class="mt-4">
        ...
        <form action="customer.php" method="POST">
            ...
            <select name="title" class="form-control" id="title">
                ...
                <option value="Mr" <?php echo (isset($customer['title']) && $customer['title'] == 'Mr') ? 'selected' : ''; ?>>Mr</option>
                <option value="Mrs" <?php echo (isset($customer['title']) && $customer['title'] == 'Mrs') ? 'selected' : ''; ?>>Mrs</option>
                <option value="Miss" <?php echo (isset($customer['title']) && $customer['title'] == 'Miss') ? 'selected' : ''; ?>>Miss</option>
                <option value="Dr" <?php echo (isset($customer['title']) && $customer['title'] == 'Dr') ? 'selected' : ''; ?>>Dr</option>
            </select>
        </div>
            <div class="form-group">
